...
<head>
  ...
  <title>Pages Deconnexion - MoLa Technologie</title>
  ...
  <main>
    <div class="container">
      ...
      <section class="section error-404 min-vh-100 d-flex flex-column align-items-center justify-content-center">
        <h1>UNLOGIN</h1>
        <h2>Voulez vous vraiment quitter! Cliquez sur le back to home pour revenir au dashboard.</h2>
        <a class="btn" href="login">Back to home</a>
        <h3>Sinon cliquez la dessous.</h3>
        <a class="btn" href="index.php">Quitt</a>
        <img src="public/templates/templateAdmin/assets/img/not-found.svg" class="img-fluid py-5" alt="Page Not Found">
        <div class="credits">
          <!-- All the links in the footer should remain intact. -->
          <!-- You can delete the links only if you purchased the pro version. -->
          <!-- Licensing information: https://bootstrapmade.com/license/ -->
          <!-- Purchase the pro version with working PHP/AJAX contact form: https://bootstrapmade.com/nice-admin-bootstrap-admin-html-template/ -->
          Designed by <a href="https://bootstrapmade.com/">MoLa Technologie</a>
        </div>
      </section>
